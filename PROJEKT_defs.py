...
def PRONOMEN(wort):
	if wort == "Ich" or wort =="ich":
		pronomen.append("S1")
	elif wort == "Du" or wort == "DU" or wort == "du":
		pronomen.append("S2")
	elif wort == "Er"or wort == "Es" or wort=="er" or wort=="es":
		pronomen.append("S3/P2")
	elif wort == "Wir" or wort == "Sie" or wort=="wir" or wort=="sie":
		pronomen.append("F/P")
	elif wort == "Ihr" or wort=="ihr":
		pronomen.append("S3/P2")
	print(pronomen)
